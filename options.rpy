...
init python:
    ...
    build.archive("scripts", "all") #Put everything labeled "DDCC" into an archive called DDCC
    build.classify("game/mod_assets/**","scripts") #Everything in the mod_assets folder
    build.classify("game/**.rpyc","scripts") #All the .rpyc files in /game
